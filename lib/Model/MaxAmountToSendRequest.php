...
/**
 * MaxAmountToSendRequest Class Doc Comment
 *
 * @category Class
 * @package  Mainnet
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class MaxAmountToSendRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaxAmountToSendRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['output_count'] = isset($data['output_count']) ? $data['output_count'] : null;
    }
    ...
    {
        return $this->container['output_count'];
    }

    /**
     * Sets output_count
     *
     * @param int|null $output_count (optional) if sending all funds to multiple addresses, the count of the number of address funds will be sent to may be included.
     *
     * @return $this
     */
    public function setOutputCount($output_count)
    {
        $this->container['output_count'] = $output_count;
